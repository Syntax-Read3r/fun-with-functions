...
function multiply(a, b) { //eslint-disable-line
  let res = a * b;
  let sent = `The product of ${a} and ${b} is ${res}.`;
...
function sumArray(sumArr) { 
  ...
  return [secondSum[0], `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${secondSum[0]} is their sum.`]
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let secondMult = multiply(firstMult[0], multArr[2]);

  return [secondMult[0],`"The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${secondMult[0]}.`];
}
